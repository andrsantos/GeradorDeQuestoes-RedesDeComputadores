...
export class GerenciamentoService {
  ...
  private readonly API_URL = 'http://187.77.240.149:83/api/gerenciamento';
  private readonly API_URL_2 = 'http://187.77.240.149:83/api/gerenciamento/listar/documentos';
  private readonly API_URL_3 = 'http://187.77.240.149:83/api/gerenciamento/listar/documentos/filtrados';
  private readonly API_URL_4 = 'http://187.77.240.149:83/api/documentacao/download';
  ...
  baixarMaterialBinario(idBinario: string): Observable<Blob> {
    const urlDownload = `http://187.77.240.149:83/api/documentacao/download/${idBinario}`; 
