...
export class ProvaService {
  ...
  private readonly API_URL = 'http://187.77.240.149:83/api/provas';
  private readonly API_URL_SALVAS = 'http://187.77.240.149:83/api/provas-salvas';
  private readonly API_URL_TOPICOS = 'http://187.77.240.149:83/api/topicos'; 
  private readonly API_QUESTOES_GERAR = 'http://187.77.240.149:83/api/questoes/gerar'; 
